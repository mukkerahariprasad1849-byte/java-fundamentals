...
public class Product {
    ...
    // Added this method for overriding
    public void displayDetails() {

        System.out.println("Id : " + id);
        System.out.println("Name : " + name);
        System.out.println("Price : " + maxRetailPrice);
    ...
    public void displayDetails(String company) {
        ...
        System.out.println("Display product details for company : " + company);
    }

    public void displayDetails(String company, String category) {

        System.out.println(
                "Display product details for company : "
                        + company +
                        " and category : "
                        + category
        );
